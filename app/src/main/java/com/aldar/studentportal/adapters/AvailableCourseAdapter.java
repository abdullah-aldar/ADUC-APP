...
public class AvailableCourseAdapter extends RecyclerView.Adapter<AvailableCourseAdapter.MyViewHolder> {
    ...
    public AvailableCourseAdapter(FragmentActivity activity, List<CoursesDataModel> data) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        AvailableCourseAdapter.MyViewHolder vh = new AvailableCourseAdapter.MyViewHolder(view);
        return vh;
    }
