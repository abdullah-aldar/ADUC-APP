...
public class StudentDashboradViewmodel extends AndroidViewModel {
    private int[] dashboardImages = {
            ...
            R.drawable.grade,R.drawable.drop
    };
    ...
    public StudentDashboradViewmodel(@NonNull Application application) {
        super(application);
        initViewInDasboard();
    }
